...
/*   Updated: 2024/12/03 21:09:09 by aamaya-g         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int color_calc(t_point current, t_point start, t_point end, t_point delta)
{
    ...
    r = calc_light((start.color >> RS) & BM, (end.color >> RS) & BM, percentage);
    g = calc_light((start.color >> GS) & BM, (end.color >> GS) & BM, percentage);
    b = calc_light(start.color & BM, end.color, percentage);
    return ((r << RS) | (g << GS) | b);
}
