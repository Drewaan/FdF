...
/*   Updated: 2024/11/28 03:45:08 by aamaya-g         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_controls(t_data *fdf)
{
	...
	mlx_string_put(mlx, window, 40, vp += 20, CYAN, "'TAB' :  ISOMETRIC/PARALLEL");
	mlx_string_put(mlx, window, 25, vp += 30, WHITE, "EXIT:");
	mlx_string_put(mlx, window, 40, vp += 20, CYAN, "'ESC'/'(X)' : CLOSE WINDOW");
}
